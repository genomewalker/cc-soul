...
def fetch_tools() -> list[dict]:
    ...
    try:
        ...
        # No daemon, no socket, or an unparseable reply. Returning [] lets the
        # caller report "no tools synced" instead of writing a truncated
        # tools_static.py over a good one.
