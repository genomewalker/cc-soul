// field_memory_structured RPC handlers — bodies for declarations in
// chitta/include/chitta/rpc/handlers/field_memory_structured.hpp.

#include "../../include/chitta/rpc/field_handler.hpp"

namespace chitta {

ToolResult FieldRpcHandler::tool_structured_recall(const json& params) {
...
ToolResult FieldRpcHandler::tool_ask(const json& params) {
