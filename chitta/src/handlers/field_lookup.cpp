// field_lookup RPC handlers — bodies for declarations in
// chitta/include/chitta/rpc/handlers/field_lookup.hpp.

#include "../../include/chitta/rpc/field_handler.hpp"

namespace chitta {

ToolResult FieldRpcHandler::tool_lookup(const json& params) {
