// drift_probe RPC handlers — bodies for declarations in
// chitta/include/chitta/rpc/handlers/drift_probe.hpp.

#include "../../include/chitta/rpc/field_handler.hpp"

namespace chitta {

ToolResult FieldRpcHandler::tool_probe_seed(const json& params) {
...
ToolResult FieldRpcHandler::tool_behavioral_probe(const json& params) {
    std::string text = params.value("text", "");
    if (text.empty()) {
...
ToolResult FieldRpcHandler::tool_probe_calibrate(const json& params) {
    std::string class_name = params.value("class", "");
    std::string text       = params.value("text", "");
