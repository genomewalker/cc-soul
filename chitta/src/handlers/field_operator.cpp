// field_operator RPC handlers — bodies for declarations in
// chitta/include/chitta/rpc/handlers/field_operator.hpp.

#include "../../include/chitta/rpc/field_handler.hpp"

namespace chitta {

ToolResult FieldRpcHandler::tool_approve_memory(const json& params) {
...
ToolResult FieldRpcHandler::tool_reject_memory(const json& params) {
    std::string id_str = params.value("id", "");
    if (id_str.empty()) return ToolResult::error("id is required");
...
ToolResult FieldRpcHandler::tool_promote_memory(const json& params) {
    std::string id_str = params.value("id", "");
    if (id_str.empty()) return ToolResult::error("id is required");
...
ToolResult FieldRpcHandler::tool_conflict_inspector(const json& params) {
...
ToolResult FieldRpcHandler::tool_disable_source(const json& params) {
...
ToolResult FieldRpcHandler::tool_operator_memory_history(const json& params) {
    std::string id_str = params.value("id", "");
    if (id_str.empty()) return ToolResult::error("id is required");
