// agent_protocol RPC handlers — bodies for declarations in
// chitta/include/chitta/rpc/handlers/agent_protocol.hpp.

#include "../../include/chitta/rpc/field_handler.hpp"

namespace chitta {

ToolResult FieldRpcHandler::tool_register_task(FieldStore* fs, const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_update_task(FieldStore* fs, const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_add_delegation(FieldStore* fs, const json& params) {
    json p;
    p["task_id"]    = params.value("task_id", 0ULL);
...
ToolResult FieldRpcHandler::tool_link_evidence(FieldStore* fs, const json& params) {
    json p;
    p["task_id"]       = params.value("task_id", 0ULL);
...
ToolResult FieldRpcHandler::tool_add_probe(FieldStore* fs, const json& params) {
    json p;
    p["task_id"]  = params.value("task_id", 0ULL);
...
ToolResult FieldRpcHandler::tool_resolve_probe(FieldStore* fs, const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_set_criterion(FieldStore* fs, const json& params) {
    json p;
    p["task_id"]   = params.value("task_id", 0ULL);
...
ToolResult FieldRpcHandler::tool_get_task(FieldStore* fs, const json& params) {
...
ToolResult FieldRpcHandler::tool_query_tasks(FieldStore* fs, const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_agent_protocol_stats(FieldStore* fs, const json&) {
