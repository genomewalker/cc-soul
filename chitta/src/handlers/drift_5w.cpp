// drift_5w RPC handlers — bodies for declarations in
// chitta/include/chitta/rpc/handlers/drift_5w.hpp.

#include "../../include/chitta/rpc/field_handler.hpp"

namespace chitta {

ToolResult FieldRpcHandler::tool_5w_search(const json& params) {
...
ToolResult FieldRpcHandler::tool_recall_ucb1(const json& params) {
