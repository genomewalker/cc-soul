// learning RPC handlers — bodies for declarations in
// chitta/include/chitta/rpc/handlers/learning.hpp.

#include "../../include/chitta/rpc/field_handler.hpp"

namespace chitta {

ToolResult FieldRpcHandler::tool_surprise_learning_stats(FieldStore* fs, const json&) {
...
ToolResult FieldRpcHandler::tool_upsert_wisdom_candidate(FieldStore* fs, const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_update_wisdom_lifecycle(FieldStore* fs, const json& params) {
...
ToolResult FieldRpcHandler::tool_query_wisdom_candidates(FieldStore* fs, const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_wisdom_promotion_stats(FieldStore* fs, const json&) {
...
ToolResult FieldRpcHandler::tool_attach_debt_evidence(FieldStore* fs, const json& params) {
...
ToolResult FieldRpcHandler::tool_update_scorer_model(FieldStore* fs, const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_learned_scorer_stats(FieldStore* fs, const json&) {
...
ToolResult FieldRpcHandler::tool_effective_scorer_weights(FieldStore* fs, const json&) {
