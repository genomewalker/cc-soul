// wisdom_lineage RPC handlers — bodies for declarations in
// chitta/include/chitta/rpc/handlers/wisdom_lineage.hpp.

#include "../../include/chitta/rpc/field_handler.hpp"

namespace chitta {

ToolResult FieldRpcHandler::tool_enroll_wisdom_lineage(FieldStore* fs, const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_transition_wisdom_lineage(FieldStore* fs, const json& params) {
...
ToolResult FieldRpcHandler::tool_close_rederive(FieldStore* fs, const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_query_wisdom_lineages(FieldStore* fs, const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_get_wisdom_lineage(FieldStore* fs, const json& params) {
    auto lineage_id = params.value("lineage_id", 0ULL);
...
ToolResult FieldRpcHandler::tool_wisdom_lineage_stats(FieldStore* fs, const json&) {
...
ToolResult FieldRpcHandler::tool_tick_lineage_staleness(FieldStore* fs, const json&) {
...
ToolResult FieldRpcHandler::tool_lineage_expiry_check(FieldStore* fs, const json&) {
