// constraint RPC handlers — bodies for declarations in
// chitta/include/chitta/rpc/handlers/constraint.hpp.

#include "../../include/chitta/rpc/field_handler.hpp"

namespace chitta {

ToolResult FieldRpcHandler::tool_assert_fact(const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_retract_fact(const json& params) {
...
ToolResult FieldRpcHandler::tool_query_unify(const json& params) {
    json p;
...
ToolResult FieldRpcHandler::tool_query_chain(const json& params) {
...
ToolResult FieldRpcHandler::tool_explain_fact(const json& params) {
    uint64_t fact_id = params.value("fact_id", uint64_t(0));
    if (fact_id == 0) return ToolResult::error("fact_id is required");
...
ToolResult FieldRpcHandler::tool_branch_create(const json& params) {
...
ToolResult FieldRpcHandler::tool_branch_resolve(const json& params) {
...
ToolResult FieldRpcHandler::tool_trigger_add(const json& params) {
...
ToolResult FieldRpcHandler::tool_trigger_list(const json&) {
...
ToolResult FieldRpcHandler::tool_trigger_fire(const json& params) {
...
ToolResult FieldRpcHandler::tool_trigger_dismiss(const json& params) {
    uint64_t trigger_id = params.value("trigger_id", uint64_t(0));
    if (trigger_id == 0) return ToolResult::error("trigger_id is required");
...
ToolResult FieldRpcHandler::tool_predict_needed(const json& params) {
