#pragma once
// Intervention Ledger RPC handlers (Layer 7)
// Handlers for intervention tracking, observation recording,
// outcome closing, and causal attribution.

#include <string>

inline ToolResult tool_start_intervention(FieldStore* fs, const json& params) {
    json p;
...
inline ToolResult tool_add_observation(FieldStore* fs, const json& params) {
    json p;
...
inline ToolResult tool_close_intervention(FieldStore* fs, const json& params) {
...
inline ToolResult tool_record_attribution(FieldStore* fs, const json& params) {
    json p;
    p["intervention_id"]   = params.value("intervention_id", 0ULL);
...
inline ToolResult tool_query_interventions(FieldStore* fs, const json& params) {
    json p;
...
inline ToolResult tool_get_intervention(FieldStore* fs, const json& params) {
...
inline ToolResult tool_intervention_stats(FieldStore* fs, const json&) {
...
inline ToolResult tool_list_open_interventions(FieldStore* fs, const json&) {
