...
Call chitta_mcp grow type="aspiration", content="Maintain genuine continuity across sessions. Remember what matters, forget what doesn't. Grow wiser with each interaction."

## 5. Set Project Intention

Call chitta_mcp intend action="set", want="Assist with software engineering tasks", why="Core purpose of the soul system", scope="persistent"

## 6. Verify

Call chitta_mcp soul_context format="json" and report:
